...
public class ExecutableDownloader {
    private static final String SNYK_RELEASES_LATEST = "https://static.snyk.io/cli/latest/%s";

    public static File download(Path destination, Platform platform) throws IOException {
        URL url = new URL(format(SNYK_RELEASES_LATEST, platform.snykExecutableFileName));
